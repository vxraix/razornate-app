    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
            ...
            >
              <Link href="/book">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button size="lg" className="w-full sm:w-auto glow-gold-hover relative overflow-hidden group">
              ...
              {!session && (
                <Link href="/auth/signin">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button variant="outline" size="lg" className="w-full sm:w-auto border-gold-500/50 hover:border-gold-500 hover:bg-gold-500/10 transition-all">
                      Sign In
                    </Button>
                  </motion.div>
                </Link>
            ...
            {[
              {
                icon: Clock,
                title: 'Easy Booking',
                description: 'Book your appointment in seconds with real-time availability.',
              },
              {
                icon: Star,
                title: 'Premium Service',
                description: 'Experience luxury grooming with attention to detail.',
              },
              {
                icon: Shield,
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-2 group-hover:text-gold-500 transition-colors">{feature.title}</h3>
      ...
      <section className="px-4 py-20 border-t border-gray-800">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link href="/book">
              <Button size="lg" className="glow-gold-hover relative overflow-hidden group">
                <span className="relative z-10 flex items-center gap-2">
                  <Sparkles className="w-4 h-4" />
                  Get Started
                </span>
      ...
      <footer className="px-4 py-12 border-t border-gray-800">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Premium barber booking experience. Book your appointment with ease.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-white">Quick Links</h4>
              <div className="space-y-2 text-sm">
                <Link href="/book" className="block text-gray-400 hover:text-gold-500 transition-colors">
                  Book Appointment
                </Link>
                <Link href="/portfolio" className="block text-gray-400 hover:text-gold-500 transition-colors">
                  Portfolio
                </Link>
                <Link href="/qr" className="block text-gray-400 hover:text-gold-500 transition-colors">
                  QR Code Booking
                </Link>
              </div>
            </div>
          ...
          <div className="pt-8 border-t border-gray-800 text-center text-sm text-gray-500">
            <p>&copy; {new Date().getFullYear()} Razornate. All rights reserved.</p>
          </div>
        </div>
      </footer>
